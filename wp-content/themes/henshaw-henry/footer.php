	...
	<div id="bottom_footer_trigger" class="bottom_footer">
		...
		<div class="footer_form_wrapper">
			...
			<div class="footer_bar">
				...
				<span>&copy; Copyright <?php echo date("Y"); ?> by <?php the_field( 'copyright','option'); ?>.</span>
			...
			<div class="desktop_social_media">
				...
				<?php if(get_field('social_media','option')): ?>
						...
						<?php while(has_sub_field('social_media','option')): ?>
							...
							<a class="<?php the_sub_field( 'class' ); ?>" href="<?php the_sub_field( 'social_media_link' ); ?>" target="_blank">
