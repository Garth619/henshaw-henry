				...
				<div class="attorney_overview">
					...
					<div class="single_attorney">
						...
						<a class="overlay" href="">
							...
							<img class="att_image" src="<?php bloginfo('template_directory');?>/images/att-henshaw.jpg"/>
							...
							<div class="atto_title_wrapper">
								...
								<a class="" href="">
									...
									<span class="att_overview_title">David S. Henshaw</span><!-- att_overview_title -->
							
									<span class="att_overview_position">Founding Partner</span><!-- att_overview_position -->
